...
- **Atributos**:
    ...
    - ´diaSemana´ : indica el dia en que se creo.
- **Métodos Abstractos**:
...
- **Métodos**:
    ...
    - ´traerListaServiciosCargados()´: Trae todos los servicios de la lista.
### 5. **NotFoundException**:
-**Metodos**:
-´tira una Exception si no encuentra algo´
